...
def run_qa_flow(question: str) -> Dict[str, Any]:
    ...
    3. Extracts and returns the final results including evidence metadata
    ...
    Returns:
        ...
        - `cited_answer`: Citation-aware answer from summarization agent
        - `context`: Retrieved context from vector store
        - `retrieved_documents`: List of Document objects from retrieval
        - `chunk_metadata`: Mapping of chunk IDs to metadata and content
    """
    graph = get_qa_graph()
