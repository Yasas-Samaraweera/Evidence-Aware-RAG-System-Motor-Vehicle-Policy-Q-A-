"""Retrieval with metadata filtering for motor vehicle categories.

This module provides retrieval functions that filter documents by vehicle type
(private cars, motorcycles, all motor vehicles) and restrictions.
"""
